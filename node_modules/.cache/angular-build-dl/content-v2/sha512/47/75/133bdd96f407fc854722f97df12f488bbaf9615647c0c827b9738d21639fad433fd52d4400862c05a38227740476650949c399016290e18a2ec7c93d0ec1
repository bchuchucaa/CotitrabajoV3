(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-register-register-module"], {
    ...
    function srcAppComponentsRegisterRegisterPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_model_cliente__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/model/cliente */
      "./src/app/model/cliente.ts");
      /* harmony import */


      var src_app_services_cliente_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/services/cliente.service */
      "./src/app/services/cliente.service.ts");

      var RegisterPage = /*#__PURE__*/function () {
        function RegisterPage(authSvc, router, clienteService) {
        ...
        _createClass(RegisterPage, [{
                  ...
                  switch (_context.prev = _context.next) {
                    ...
                    case 3:
                      ...
                      if (user) {
                        ...
                        this.redirectUser(isVerified, user); //Todo: CheckEmail
                      }
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                      ...
                      this.router.navigate(['log-in']); // this.aSvc.login(this.userInfo.email);
          ...
          key: "registerClient",
          value: function registerClient(email, passowrd) {
