  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-view-cliente-view-cliente-module"], {
    ...
    function srcAppComponentsViewClienteViewClientePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ViewClientePage = /*#__PURE__*/function () {
        function ViewClientePage(route, router, obrasService, notificacionesService) {
          var _this = this;
          ...
          this.route.queryParams.subscribe(function (params) {
            ...
            if (_this.router.getCurrentNavigation().extras.queryParams) {
              _this.uid = _this.router.getCurrentNavigation().extras.queryParams.uid;
            }
          });
        ...
        _createClass(ViewClientePage, [{
          ...
          key: "editarContactoById",
          value: function editarContactoById() {}
        }, {
          key: "borrarContacto",
          value: function borrarContacto(uid) {
          ...
          value: function confirmarBorrado(uid) {
          ...
          key: "verificarSesion",
          value: function verificarSesion() {
