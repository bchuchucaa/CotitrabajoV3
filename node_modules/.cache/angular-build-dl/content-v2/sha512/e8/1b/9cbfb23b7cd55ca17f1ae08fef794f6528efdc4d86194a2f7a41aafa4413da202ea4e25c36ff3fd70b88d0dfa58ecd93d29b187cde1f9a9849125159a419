...
const routes = [
    ...
    {
        path: 'log-in',
        loadChildren: () => Promise.all(/*! import() | components-log-in-log-in-module */[__webpack_require__.e("default~components-log-in-log-in-module~components-register-register-module~components-registro-clie~935530ef"), __webpack_require__.e("common"), __webpack_require__.e("components-log-in-log-in-module")]).then(__webpack_require__.bind(null, /*! ./components/log-in/log-in.module */ "./src/app/components/log-in/log-in.module.ts")).then(m => m.LogInPageModule)
    },
    {
        path: 'registro-cliente',
        loadChildren: () => Promise.all(/*! import() | components-registro-cliente-registro-cliente-module */[__webpack_require__.e("default~components-log-in-log-in-module~components-register-register-module~components-registro-clie~935530ef"), __webpack_require__.e("common"), __webpack_require__.e("components-registro-cliente-registro-cliente-module")]).then(__webpack_require__.bind(null, /*! ./components/registro-cliente/registro-cliente.module */ "./src/app/components/registro-cliente/registro-cliente.module.ts")).then(m => m.RegistroClientePageModule)
    },
    {
        path: 'home',
    ...
    {
        path: 'localizacion',
        loadChildren: () => __webpack_require__.e(/*! import() | localizacion-localizacion-module */ "localizacion-localizacion-module").then(__webpack_require__.bind(null, /*! ./localizacion/localizacion.module */ "./src/app/localizacion/localizacion.module.ts")).then(m => m.LocalizacionPageModule)
    },
    {
        path: 'logintest',
    ...
    {
        path: 'register',
        loadChildren: () => Promise.all(/*! import() | components-register-register-module */[__webpack_require__.e("default~components-log-in-log-in-module~components-register-register-module~components-registro-clie~935530ef"), __webpack_require__.e("components-register-register-module")]).then(__webpack_require__.bind(null, /*! ./components/register/register.module */ "./src/app/components/register/register.module.ts")).then(m => m.RegisterPageModule)
    },
    {
        path: 'login',
        loadChildren: () => Promise.all(/*! import() | components-login-login-module */[__webpack_require__.e("common"), __webpack_require__.e("components-login-login-module")]).then(__webpack_require__.bind(null, /*! ./components/login/login.module */ "./src/app/components/login/login.module.ts")).then(m => m.LoginPageModule)
...
module.exports = __webpack_require__(/*! /Users/israelchuchuca/IONIC/Cotitrabajo/src/main.ts */"./src/main.ts");
