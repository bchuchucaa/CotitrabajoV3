(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-crear-obra-crear-obra-module"], {
    ...
    function srcAppComponentsCrearObraCrearObraPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      "./node_modules/@ionic-native/camera/__ivy_ngcc__/ngx/index.js"); //IMPORT TO UPLOAD IMAGES BY SCORPION


      var CrearObraPage = /*#__PURE__*/function () {
        function CrearObraPage(camera, storage, database, route, router, obraService, notificacionesService) {
        ...
        _createClass(CrearObraPage, [{
          ...
          key: "imageSeleccionada",
          value: function imageSeleccionada(data) {
          ...
          key: "uploadFinished",
          value: function uploadFinished(data) {
